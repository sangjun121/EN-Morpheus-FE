                    ...
                    <div className="final_pages_page__inner">
                        ...
                        <div className="final_content">
                            <div className="final_content_section">
                                <h2>Episode 1</h2>
                                <p>
                                    {/*서버에서 정보 받아온 것 기입 */}On a
                                    sunny day, curious Lily discovers something
                                    shiny while exploring the forest. 'Wow,
                                    what's this?' Lily marvels at the spaceship
                                    with curious eyes.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="final_pages_page__inner">
                        ...
                        <div className="final_content">
                            <div className="final_content_section">
                                <h2>Episode 2</h2>
                                <p>
                                    {/*서버에서 정보 받아온 것 기입 */}'This is
                                    a real spaceship!' Lily explores inside the
                                    spaceship. Suddenly, the spaceship begins to
                                    move slightly.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="final_pages_page__inner">
                        ...
                        <div className="final_content">
                            <div className="final_content_section">
                                <h2>Episode 3</h2>
                                <p>
                                    {/*서버에서 정보 받아온 것 기입 */}As the
                                    spaceship soars into the sky, Lily laughs
                                    excitedly. 'We're going to space!' Lily
                                    exclaims.
                                </p>
                            </div>
                        </div>
